...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.auto_exposure_limit_toggle', 'default': 'true', 'description': '[ADD]'},
                           {'name': 'depth_module.auto_exposure_limit', 'default': '5000', 'description': '[ADD]'},
                           {'name': 'depth_module.emitter_enabled', 'default': '0', 'description': '[ADD]'},
